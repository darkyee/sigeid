                                    ...
                                    item.times.map((time, timeIndex) => (
                                        <div key={timeIndex} style={{ maxWidth: 250 }} className="mb-2">
                                            <div className="d-flex align-items-center">
                                                <input className="form-control" type="time" value={time.start} min={diponible.min} max={diponible.max} step="3600" onChange={(e) => actualizarTiempoStart(e, index, timeIndex)}></input>
                                                <div className="mx-2">-</div>
                                                <input className="form-control" type="time" value={time.end} min={diponible.min} max={diponible.max} step="3600" onChange={(e) => actualizarTiempoEnd(e, index, timeIndex)}></input>
